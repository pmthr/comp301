...
public class Adept {
   ...
   * See: <a href="https://docs.oracle.com/javase/7/docs/api/java/io/BufferedReader.html#close()">...</a>
   * <p>
   ...
   * the accumulated contents as a String. See: <a href="https://docs.oracle.com/javase/7/docs/api/java/io/BufferedReader.html#readLine()">...</a>
   */
  public static String section6(String urlText) {
    try (BufferedReader reader = section5(urlText)) {
      String line;
